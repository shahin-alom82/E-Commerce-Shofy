...
const CartProduct = ({ product }: Props) => {
      ...
      return (
            <Container className="flex flex-col lg:flex-row gap-4 border-t py-4 border-gray-300 relative">
                  <div className="">
                  ...
                  <div>
                        ...
                        <h1 className="flex lg:items-center gap-2 mt-2"> You are saving <PriceFormate className="text-green-500 font-medium text-[16px]" amount={product?.price * (product?.discountPercentage / 100) * product?.quantity!} /> upon purchase</h1>
                  </div>
